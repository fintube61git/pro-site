...
class CvWorkflowTests(unittest.TestCase):
    ...
    def test_browser_native_cv_lists_and_resume(self) -> None:
        ...
        css = read_text(REPO_ROOT / "css" / "styles.v2.css")
        markdown_js = read_text(REPO_ROOT / "js" / "markdown.js")
        ...
        self.assertIn("Print CV", cv_page)
        self.assertIn('src="../js/markdown.js"', cv_page)
        self.assertIn('src="../js/markdown.js"', resume_page)
        self.assertNotIn("cdn.jsdelivr.net/npm/marked", cv_page)
        self.assertNotIn("cdn.jsdelivr.net/npm/marked", resume_page)
        self.assertIn("window.TdwMarkdown", markdown_js)
        self.assertIn("state.inComment", markdown_js)
